...
% --------------------------------------------------------------------------------------
function [J, grad] = costFunction(theta, lambda,  tax, sy, st, v, w, wt, wtt, wttt)
J = 0;
...
[theta] = fminunc (@(t)(costFunction(t, lambda,  tax, sy, st, v, w, wt, wtt, wttt)), theta0, options);
theta
plot(tax*theta)
endif
...
for t0=1:nn0
 for t1=1:nn1
   ...
   theta(1) = th0(t0);
   theta(2) = th1(t1);
   pl(t0,t1) = costFunction(theta, lambda,  tax, sy, st, v, w, wt, wtt, wttt);
endfor
endfor
meshc(th0, th1, pl);
xlabel("theta_1");
...
[J,g] = costFunction(th0, lambda,  tax, sy, st, v, w, wt, wtt, wttt);
for i=1:4
 th = th0;
 th(i) = th(i) + delta;
 Jplus = costFunction(th, lambda,  tax, sy, st, v, w, wt, wtt, wttt)
 th = th0;
 th(i) = th(i) - delta;
 Jminus = costFunction(th, lambda,  tax, sy, st, v, w, wt, wtt, wttt)
